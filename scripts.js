...
var description_one = document.getElementById("photo_one");
description_one.innerHTML = "Yeah, why not? 'Cause it's just pure. Pure and complete gnarlyisms. You know, he might be nails, but I'm frickin bayonets, you know? I am battle-tested bayonets, bro."

var description_two = document.getElementById("photo_two");
description_two.innerText = "But ... whatever. I agreed to do it. There's just one deal point that Jim Robinson - a wonderful man at Morgan Creek, a great company - need to work out is they want me in it. If they do, it's a smash. If they don't, it's a turd that opens on a tugboat.  Well, yeah. But I was gonna tell you, I'm tired of being told like, 'Oh, you can't talk about that. You can't talk about that."
